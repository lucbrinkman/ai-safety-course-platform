...
- A**series of blog posts**: I'd suggest starting with the [Roadmap](https://www.cold-takes.com/most-important-century-series-roadmap/). (Each piece links to the next piece at the end.) This is the original format, where it will be easiest to click around, see graphics at full size, etc. - An
**audio series**available on most podcast platforms (Spotify, Stitcher, Apple Podcasts, etc.): - A single [printable pdf](https://www.cold-takes.com/assets/files/most-important-century-consolidated.pdf).
...
Over the last few years - thanks to general dialogue with the [effective altruism](https://en.wikipedia.org/wiki/Effective_altruism) community, and extensive research done by [Open Philanthropy's Worldview Investigations team](https://www.cold-takes.com/roadmap-for-the-most-important-century-series/#acknowledgements) - I've become convinced that humanity as a whole faces huge risks and opportunities this century. Better understanding and preparing for these risks and opportunities is where I am now focused.

This piece will summarize a [series](https://www.cold-takes.com/roadmap-for-the-most-important-century-series/) of posts on why I believe we could be in the **most important century of all time for humanity**. It gives a short summary, key post(s), and sometimes key graphics for 5 basic points:

**The long-run future is radically unfamiliar.**Enough advances in technology could lead to a long-lasting, galaxy-wide civilization that could be a radical [utopia](/tag/utopia/), dystopia, or anything in between.**The long-run future could come much faster than we think,**due to a possible AI-driven productivity explosion.- The relevant kind of
**AI looks like it will be developed this century**- making this century the one that will initiate, and have the opportunity to shape, a future galaxy-wide civilization. - These claims seem too "wild" to take seriously. But there are a lot of reasons to think that
**we live in a wild time, and should be ready for anything.**- We, the people living in this century, have the chance to have a huge impact on huge numbers of people to come - if we can make sense of the situation enough to find helpful actions. But right now,**we aren't ready for this.**This thesis has a wacky, sci-fi feel. It's very far from where I expected to end up when I set out to do as much good as possible.
...
![Chart of the world economy starting in about 1950. It looks like a straight line (on a logarithmic y-axis), with a dotted straight line projecting more of the same for the future.](https://www.cold-takes.com/content/images/size/w1000/2021/07/business-as-usual.png)
...
Key piece: [Digital People Would Be An Even Bigger Deal](https://www.cold-takes.com/how-digital-people-could-change-the-world/)
...
- [The Duplicator: Instant Cloning Would Make the World Economy Explode](https://www.cold-takes.com/the-duplicator/)
...
- [AI Timelines: Where the Arguments, and the "Experts," Stand](https://www.cold-takes.com/p/32cbd365-0a56-4ecc-a597-f18fbc3adb2b/) (recaps the others, and discusses how we should reason about topics like this where it's unclear who the "experts" are)
- [Forecasting Transformative AI: What's the Burden of Proof?](https://www.cold-takes.com/forecasting-transformative-ai-whats-the-burden-of-proof/)
- [Are we "trending toward" transformative AI?](https://www.cold-takes.com/are-we-trending-toward-transformative-ai-how-would-we-know/)
...
With that in mind, rather than a "call to action," I issue a [Call to Vigilance](https://www.cold-takes.com/call-to-vigilance/):

- If you're convinced by the arguments in this series, then don't rush to "do something" and then move on.
- Instead, take whatever [robustly good actions](https://www.cold-takes.com/making-the-best-of-the-most-important-century/#robustly-helpful-actions) you can today, and otherwise put yourself in a better position to take important actions when the time comes.
- For those looking for a quick action that will make future action more likely, see [this section of "Call to Vigilance."](https://www.cold-takes.com/call-to-vigilance/#buttons-you-can-click)
...
![Animated image of the view out the airplane window as it blasts down the runway.](https://www.cold-takes.com/content/images/2021/07/airplane-launch-compressed.gif)
