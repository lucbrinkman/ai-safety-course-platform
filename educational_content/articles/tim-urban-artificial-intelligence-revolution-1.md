...
* And those are just in the consumer world. Sophisticated ANI systems are widely used in sectors and industries like military, manufacturing, and finance (algorithmic high-frequency AI traders account for more than half of equity shares traded on US markets), and in expert systems like those that help doctors make diagnoses and, most famously, IBM's [Watson](http://www.ibm.com/smarterplanet/us/en/ibmwatson/), who contained enough facts and understood coy Trebek-speak well enough to soundly beat the most prolific _Jeopardy_ champions.
